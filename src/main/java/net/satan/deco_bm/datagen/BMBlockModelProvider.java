...
public class BMBlockModelProvider extends BlockModelProvider {
    ...
    private BlockModelBuilder barsModels(DeferredBlock<Block> block) {
        ...
        ResourceLocation bars = ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID, "block/" + block.getId().getPath());
    ...
    private BlockModelBuilder barsNoCapModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsNonstraightNoCapModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsNonstraightModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsVModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsUNoCapModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsReverseVModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsReverseUNoCapModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsUModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder barsReverseUModels(DeferredBlock<Block> block) {
        String name = block.getId().toString();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        String blockId = BMSupGen.BlockIdFilter(block);
        String mId = BMSupGen.ModIdFilter(block);
    ...
    private BlockModelBuilder panelModels(DeferredBlock<Block> block) {
       String name = block.getId().getPath();
        if (block.getId().getPath().contains("waxed_")) block = BMSupGen.getDecoNonWaxed(block);
        ResourceLocation texture1 = ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID, "block/" + BMSupGen.getPanelTexture(block,0));
        ResourceLocation texture2 = ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID, "block/" + BMSupGen.getPanelTexture(block,1));
        ResourceLocation texture3 = ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID, "block/" + BMSupGen.getPanelTexture(block,2));
        ResourceLocation texture4 = ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID, "block/" + BMSupGen.getPanelTexture(block,3));
    ...
    public BlockModelBuilder barsSide(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side", ResourceLocation.withDefaultNamespace("block/iron_bars_side"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideAlt(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side_alt", ResourceLocation.withDefaultNamespace("block/iron_bars_side_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsCap(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_cap", ResourceLocation.withDefaultNamespace("block/iron_bars_cap"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsCapAlt(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_cap_alt", ResourceLocation.withDefaultNamespace("block/iron_bars_cap_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideNonstraight(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/nonstraight_bars_side"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideAltNonstraight(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side_alt",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/nonstraight_bars_side_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideV(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/v_bars_side"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideAltV(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side_alt",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/v_bars_side_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideReverseV(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/reverse_v_bars_side"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideAltReverseV(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side_alt",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/reverse_v_bars_side_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideU(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/u_bars_side"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideAltU(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side_alt",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/u_bars_side_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideReverseU(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/reverse_u_bars_side"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder barsSideAltReverseU(String name, ResourceLocation particle, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_side_alt",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/bars/reverse_u_bars_side_alt"))
                .texture("particle", particle)
                .texture("bars", bars)
                .texture("edge", edge).renderType("cutout_mipped");
    }
    ...
    public BlockModelBuilder panelRot0(String name, ResourceLocation bars, ResourceLocation edge) {
        return withExistingParent(name + "_rotation_0",
                ResourceLocation.fromNamespaceAndPath(satans_deco_bm.MODID,"block/panel/template_panel"))
                .texture("bars", bars)
                .texture("edge", edge)
