...
public class DecoRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> recipe) {
      //bars
        ...
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE1.get(), DecoBlocks.IRON_VITRAGE_PANE.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE2.get(), DecoBlocks.IRON_VITRAGE_PANE1.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE3.get(), DecoBlocks.IRON_VITRAGE_PANE2.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE4.get(), DecoBlocks.IRON_VITRAGE_PANE3.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE5.get(), DecoBlocks.IRON_VITRAGE_PANE4.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE6.get(), DecoBlocks.IRON_VITRAGE_PANE5.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE7.get(), DecoBlocks.IRON_VITRAGE_PANE6.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE8.get(), DecoBlocks.IRON_VITRAGE_PANE7.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE9.get(), DecoBlocks.IRON_VITRAGE_PANE8.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE10.get(), DecoBlocks.IRON_VITRAGE_PANE9.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE11.get(), DecoBlocks.IRON_VITRAGE_PANE10.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE12.get(), DecoBlocks.IRON_VITRAGE_PANE11.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE13.get(), DecoBlocks.IRON_VITRAGE_PANE12.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE14.get(), DecoBlocks.IRON_VITRAGE_PANE13.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE15.get(), DecoBlocks.IRON_VITRAGE_PANE14.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE16.get(), DecoBlocks.IRON_VITRAGE_PANE15.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE17.get(), DecoBlocks.IRON_VITRAGE_PANE16.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE18.get(), DecoBlocks.IRON_VITRAGE_PANE17.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE19.get(), DecoBlocks.IRON_VITRAGE_PANE18.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE20.get(), DecoBlocks.IRON_VITRAGE_PANE19.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE21.get(), DecoBlocks.IRON_VITRAGE_PANE20.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE22.get(), DecoBlocks.IRON_VITRAGE_PANE21.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE23.get(), DecoBlocks.IRON_VITRAGE_PANE22.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE24.get(), DecoBlocks.IRON_VITRAGE_PANE23.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE26.get(), DecoBlocks.IRON_VITRAGE_PANE24.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE27.get(), DecoBlocks.IRON_VITRAGE_PANE26.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE28.get(), DecoBlocks.IRON_VITRAGE_PANE27.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE30.get(), DecoBlocks.IRON_VITRAGE_PANE28.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE33.get(), DecoBlocks.IRON_VITRAGE_PANE30.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE34.get(), DecoBlocks.IRON_VITRAGE_PANE33.get(), 1, DecoBlocks.IRON_VITRAGE_PANE.get(), DecoTags.DecoItems.IRON_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE1.get(), DecoBlocks.GOLD_VITRAGE_PANE.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE2.get(), DecoBlocks.GOLD_VITRAGE_PANE1.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE3.get(), DecoBlocks.GOLD_VITRAGE_PANE2.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE4.get(), DecoBlocks.GOLD_VITRAGE_PANE3.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE5.get(), DecoBlocks.GOLD_VITRAGE_PANE4.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE6.get(), DecoBlocks.GOLD_VITRAGE_PANE5.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE7.get(), DecoBlocks.GOLD_VITRAGE_PANE6.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE8.get(), DecoBlocks.GOLD_VITRAGE_PANE7.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE9.get(), DecoBlocks.GOLD_VITRAGE_PANE8.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE10.get(), DecoBlocks.GOLD_VITRAGE_PANE9.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE11.get(), DecoBlocks.GOLD_VITRAGE_PANE10.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE12.get(), DecoBlocks.GOLD_VITRAGE_PANE11.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE13.get(), DecoBlocks.GOLD_VITRAGE_PANE12.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE14.get(), DecoBlocks.GOLD_VITRAGE_PANE13.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE15.get(), DecoBlocks.GOLD_VITRAGE_PANE14.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE16.get(), DecoBlocks.GOLD_VITRAGE_PANE15.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE17.get(), DecoBlocks.GOLD_VITRAGE_PANE16.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE18.get(), DecoBlocks.GOLD_VITRAGE_PANE17.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE19.get(), DecoBlocks.GOLD_VITRAGE_PANE18.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE20.get(), DecoBlocks.GOLD_VITRAGE_PANE19.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE21.get(), DecoBlocks.GOLD_VITRAGE_PANE20.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE22.get(), DecoBlocks.GOLD_VITRAGE_PANE21.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE23.get(), DecoBlocks.GOLD_VITRAGE_PANE22.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE24.get(), DecoBlocks.GOLD_VITRAGE_PANE23.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE26.get(), DecoBlocks.GOLD_VITRAGE_PANE24.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE27.get(), DecoBlocks.GOLD_VITRAGE_PANE26.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE28.get(), DecoBlocks.GOLD_VITRAGE_PANE27.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE30.get(), DecoBlocks.GOLD_VITRAGE_PANE28.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE33.get(), DecoBlocks.GOLD_VITRAGE_PANE30.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE34.get(), DecoBlocks.GOLD_VITRAGE_PANE33.get(), 1, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoTags.DecoItems.GOLD_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE1.get(), DecoBlocks.EMERALD_VITRAGE_PANE.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE2.get(), DecoBlocks.EMERALD_VITRAGE_PANE1.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE3.get(), DecoBlocks.EMERALD_VITRAGE_PANE2.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE4.get(), DecoBlocks.EMERALD_VITRAGE_PANE3.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE5.get(), DecoBlocks.EMERALD_VITRAGE_PANE4.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE6.get(), DecoBlocks.EMERALD_VITRAGE_PANE5.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE7.get(), DecoBlocks.EMERALD_VITRAGE_PANE6.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE8.get(), DecoBlocks.EMERALD_VITRAGE_PANE7.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE9.get(), DecoBlocks.EMERALD_VITRAGE_PANE8.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE10.get(), DecoBlocks.EMERALD_VITRAGE_PANE9.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE11.get(), DecoBlocks.EMERALD_VITRAGE_PANE10.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE12.get(), DecoBlocks.EMERALD_VITRAGE_PANE11.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE13.get(), DecoBlocks.EMERALD_VITRAGE_PANE12.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE14.get(), DecoBlocks.EMERALD_VITRAGE_PANE13.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE15.get(), DecoBlocks.EMERALD_VITRAGE_PANE14.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE16.get(), DecoBlocks.EMERALD_VITRAGE_PANE15.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE17.get(), DecoBlocks.EMERALD_VITRAGE_PANE16.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE18.get(), DecoBlocks.EMERALD_VITRAGE_PANE17.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE19.get(), DecoBlocks.EMERALD_VITRAGE_PANE18.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE20.get(), DecoBlocks.EMERALD_VITRAGE_PANE19.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE21.get(), DecoBlocks.EMERALD_VITRAGE_PANE20.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE22.get(), DecoBlocks.EMERALD_VITRAGE_PANE21.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE23.get(), DecoBlocks.EMERALD_VITRAGE_PANE22.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE24.get(), DecoBlocks.EMERALD_VITRAGE_PANE23.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE26.get(), DecoBlocks.EMERALD_VITRAGE_PANE24.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE27.get(), DecoBlocks.EMERALD_VITRAGE_PANE26.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE28.get(), DecoBlocks.EMERALD_VITRAGE_PANE27.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE30.get(), DecoBlocks.EMERALD_VITRAGE_PANE28.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE33.get(), DecoBlocks.EMERALD_VITRAGE_PANE30.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE34.get(), DecoBlocks.EMERALD_VITRAGE_PANE33.get(), 1, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoTags.DecoItems.EMERALD_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE1.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE2.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE1.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE3.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE2.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE4.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE3.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE5.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE4.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE6.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE5.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE7.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE6.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE8.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE7.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE9.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE8.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE10.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE9.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE11.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE10.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE12.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE11.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE13.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE12.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE14.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE13.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE15.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE14.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE16.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE15.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE17.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE16.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE18.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE17.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE19.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE18.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE20.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE19.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE21.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE20.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE22.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE21.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE23.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE22.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE24.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE23.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE26.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE24.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE27.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE26.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE28.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE27.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE30.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE28.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE33.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE30.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE34.get(), DecoBlocks.DARKMETAL_VITRAGE_PANE33.get(), 1, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoTags.DecoItems.DARKMETAL_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE1.get(), DecoBlocks.CLOUD_VITRAGE_PANE.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE2.get(), DecoBlocks.CLOUD_VITRAGE_PANE1.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE3.get(), DecoBlocks.CLOUD_VITRAGE_PANE2.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE4.get(), DecoBlocks.CLOUD_VITRAGE_PANE3.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE5.get(), DecoBlocks.CLOUD_VITRAGE_PANE4.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE6.get(), DecoBlocks.CLOUD_VITRAGE_PANE5.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE7.get(), DecoBlocks.CLOUD_VITRAGE_PANE6.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE8.get(), DecoBlocks.CLOUD_VITRAGE_PANE7.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE9.get(), DecoBlocks.CLOUD_VITRAGE_PANE8.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE10.get(), DecoBlocks.CLOUD_VITRAGE_PANE9.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE11.get(), DecoBlocks.CLOUD_VITRAGE_PANE10.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE12.get(), DecoBlocks.CLOUD_VITRAGE_PANE11.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE13.get(), DecoBlocks.CLOUD_VITRAGE_PANE12.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE14.get(), DecoBlocks.CLOUD_VITRAGE_PANE13.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE15.get(), DecoBlocks.CLOUD_VITRAGE_PANE14.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE16.get(), DecoBlocks.CLOUD_VITRAGE_PANE15.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE17.get(), DecoBlocks.CLOUD_VITRAGE_PANE16.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE18.get(), DecoBlocks.CLOUD_VITRAGE_PANE17.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE19.get(), DecoBlocks.CLOUD_VITRAGE_PANE18.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE20.get(), DecoBlocks.CLOUD_VITRAGE_PANE19.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE21.get(), DecoBlocks.CLOUD_VITRAGE_PANE20.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE22.get(), DecoBlocks.CLOUD_VITRAGE_PANE21.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE23.get(), DecoBlocks.CLOUD_VITRAGE_PANE22.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE24.get(), DecoBlocks.CLOUD_VITRAGE_PANE23.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE26.get(), DecoBlocks.CLOUD_VITRAGE_PANE24.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE27.get(), DecoBlocks.CLOUD_VITRAGE_PANE26.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE28.get(), DecoBlocks.CLOUD_VITRAGE_PANE27.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE30.get(), DecoBlocks.CLOUD_VITRAGE_PANE28.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE33.get(), DecoBlocks.CLOUD_VITRAGE_PANE30.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE34.get(), DecoBlocks.CLOUD_VITRAGE_PANE33.get(), 1, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoTags.DecoItems.CLOUD_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE1.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE2.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE3.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE4.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE5.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE6.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE7.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE8.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE9.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE10.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE11.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE12.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE13.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE14.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE15.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE16.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE17.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE18.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE19.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE20.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE21.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE22.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE23.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE24.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE26.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE27.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE28.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE30.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_COPPER_VITRAGE_PANE33.get(), 1, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_COPPER_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE1.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE2.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE3.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE4.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE5.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE6.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE7.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE8.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE9.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE10.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE11.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE12.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE13.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE14.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE15.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE16.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE17.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE18.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE19.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE20.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE21.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE22.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE23.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE24.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE26.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE27.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE28.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE30.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE33.get(), 1, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_EXPOSED_COPPER_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE1.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE2.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE3.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE4.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE5.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE6.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE7.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE8.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE9.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE10.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE11.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE12.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE13.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE14.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE15.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE16.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE17.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE18.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE19.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE20.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE21.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE22.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE23.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE24.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE26.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE27.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE28.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE30.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE33.get(), 1, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_WEATHERED_COPPER_VITRAGES);

        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE1.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE2.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE3.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE4.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE5.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE6.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE7.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE8.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE9.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE10.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE11.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE12.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE13.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE14.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE15.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE16.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE17.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE18.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE19.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE20.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE21.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE22.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE23.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE24.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE26.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE27.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE28.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE30.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);
        barsMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE33.get(), 1, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoTags.DecoItems.WAXED_OXIDIZED_COPPER_VITRAGES);

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE.get(), Blocks.IRON_BARS, Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE1.get(), DecoBlocks.IRON_BARS1.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE2.get(), DecoBlocks.IRON_BARS2.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE3.get(), DecoBlocks.IRON_BARS3.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE4.get(), DecoBlocks.IRON_BARS4.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE5.get(), DecoBlocks.IRON_BARS5.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE6.get(), DecoBlocks.IRON_BARS6.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE7.get(), DecoBlocks.IRON_BARS7.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE8.get(), DecoBlocks.IRON_BARS8.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE9.get(), DecoBlocks.IRON_BARS9.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE10.get(), DecoBlocks.IRON_BARS10.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE11.get(), DecoBlocks.IRON_BARS11.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE12.get(), DecoBlocks.IRON_BARS12.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE13.get(), DecoBlocks.IRON_BARS13.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE14.get(), DecoBlocks.IRON_BARS14.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE15.get(), DecoBlocks.IRON_BARS15.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE16.get(), DecoBlocks.IRON_BARS16.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE17.get(), DecoBlocks.IRON_BARS17.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE18.get(), DecoBlocks.IRON_BARS18.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE19.get(), DecoBlocks.IRON_BARS19.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE20.get(), DecoBlocks.IRON_BARS20.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE21.get(), DecoBlocks.IRON_BARS21.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE22.get(), DecoBlocks.IRON_BARS22.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE23.get(), DecoBlocks.IRON_BARS23.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE24.get(), DecoBlocks.IRON_BARS24.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE26.get(), DecoBlocks.IRON_BARS26.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE27.get(), DecoBlocks.IRON_BARS27.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE28.get(), DecoBlocks.IRON_BARS28.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE30.get(), DecoBlocks.IRON_BARS30.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE33.get(), DecoBlocks.IRON_BARS33.get(), Blocks.IRON_BARS);
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.IRON_VITRAGE_PANE34.get(), DecoBlocks.IRON_BARS34.get(), Blocks.IRON_BARS);

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE.get(), DecoBlocks.GOLD_BARS.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE1.get(), DecoBlocks.GOLD_BARS1.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE2.get(), DecoBlocks.GOLD_BARS2.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE3.get(), DecoBlocks.GOLD_BARS3.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE4.get(), DecoBlocks.GOLD_BARS4.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE5.get(), DecoBlocks.GOLD_BARS5.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE6.get(), DecoBlocks.GOLD_BARS6.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE7.get(), DecoBlocks.GOLD_BARS7.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE8.get(), DecoBlocks.GOLD_BARS8.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE9.get(), DecoBlocks.GOLD_BARS9.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE10.get(), DecoBlocks.GOLD_BARS10.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE11.get(), DecoBlocks.GOLD_BARS11.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE12.get(), DecoBlocks.GOLD_BARS12.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE13.get(), DecoBlocks.GOLD_BARS13.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE14.get(), DecoBlocks.GOLD_BARS14.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE15.get(), DecoBlocks.GOLD_BARS15.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE16.get(), DecoBlocks.GOLD_BARS16.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE17.get(), DecoBlocks.GOLD_BARS17.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE18.get(), DecoBlocks.GOLD_BARS18.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE19.get(), DecoBlocks.GOLD_BARS19.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE20.get(), DecoBlocks.GOLD_BARS20.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE21.get(), DecoBlocks.GOLD_BARS21.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE22.get(), DecoBlocks.GOLD_BARS22.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE23.get(), DecoBlocks.GOLD_BARS23.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE24.get(), DecoBlocks.GOLD_BARS24.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE26.get(), DecoBlocks.GOLD_BARS26.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE27.get(), DecoBlocks.GOLD_BARS27.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE28.get(), DecoBlocks.GOLD_BARS28.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE30.get(), DecoBlocks.GOLD_BARS30.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE33.get(), DecoBlocks.GOLD_BARS33.get(), DecoBlocks.GOLD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.GOLD_VITRAGE_PANE34.get(), DecoBlocks.GOLD_BARS34.get(), DecoBlocks.GOLD_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE.get(), DecoBlocks.EMERALD_BARS.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE1.get(), DecoBlocks.EMERALD_BARS1.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE2.get(), DecoBlocks.EMERALD_BARS2.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE3.get(), DecoBlocks.EMERALD_BARS3.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE4.get(), DecoBlocks.EMERALD_BARS4.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE5.get(), DecoBlocks.EMERALD_BARS5.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE6.get(), DecoBlocks.EMERALD_BARS6.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE7.get(), DecoBlocks.EMERALD_BARS7.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE8.get(), DecoBlocks.EMERALD_BARS8.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE9.get(), DecoBlocks.EMERALD_BARS9.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE10.get(), DecoBlocks.EMERALD_BARS10.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE11.get(), DecoBlocks.EMERALD_BARS11.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE12.get(), DecoBlocks.EMERALD_BARS12.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE13.get(), DecoBlocks.EMERALD_BARS13.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE14.get(), DecoBlocks.EMERALD_BARS14.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE15.get(), DecoBlocks.EMERALD_BARS15.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE16.get(), DecoBlocks.EMERALD_BARS16.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE17.get(), DecoBlocks.EMERALD_BARS17.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE18.get(), DecoBlocks.EMERALD_BARS18.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE19.get(), DecoBlocks.EMERALD_BARS19.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE20.get(), DecoBlocks.EMERALD_BARS20.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE21.get(), DecoBlocks.EMERALD_BARS21.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE22.get(), DecoBlocks.EMERALD_BARS22.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE23.get(), DecoBlocks.EMERALD_BARS23.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE24.get(), DecoBlocks.EMERALD_BARS24.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE26.get(), DecoBlocks.EMERALD_BARS26.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE27.get(), DecoBlocks.EMERALD_BARS27.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE28.get(), DecoBlocks.EMERALD_BARS28.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE30.get(), DecoBlocks.EMERALD_BARS30.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE33.get(), DecoBlocks.EMERALD_BARS33.get(), DecoBlocks.EMERALD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.EMERALD_VITRAGE_PANE34.get(), DecoBlocks.EMERALD_BARS34.get(), DecoBlocks.EMERALD_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE.get(), DecoBlocks.DARKMETAL_BARS.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE1.get(), DecoBlocks.DARKMETAL_BARS1.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE2.get(), DecoBlocks.DARKMETAL_BARS2.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE3.get(), DecoBlocks.DARKMETAL_BARS3.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE4.get(), DecoBlocks.DARKMETAL_BARS4.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE5.get(), DecoBlocks.DARKMETAL_BARS5.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE6.get(), DecoBlocks.DARKMETAL_BARS6.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE7.get(), DecoBlocks.DARKMETAL_BARS7.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE8.get(), DecoBlocks.DARKMETAL_BARS8.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE9.get(), DecoBlocks.DARKMETAL_BARS9.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE10.get(), DecoBlocks.DARKMETAL_BARS10.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE11.get(), DecoBlocks.DARKMETAL_BARS11.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE12.get(), DecoBlocks.DARKMETAL_BARS12.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE13.get(), DecoBlocks.DARKMETAL_BARS13.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE14.get(), DecoBlocks.DARKMETAL_BARS14.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE15.get(), DecoBlocks.DARKMETAL_BARS15.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE16.get(), DecoBlocks.DARKMETAL_BARS16.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE17.get(), DecoBlocks.DARKMETAL_BARS17.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE18.get(), DecoBlocks.DARKMETAL_BARS18.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE19.get(), DecoBlocks.DARKMETAL_BARS19.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE20.get(), DecoBlocks.DARKMETAL_BARS20.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE21.get(), DecoBlocks.DARKMETAL_BARS21.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE22.get(), DecoBlocks.DARKMETAL_BARS22.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE23.get(), DecoBlocks.DARKMETAL_BARS23.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE24.get(), DecoBlocks.DARKMETAL_BARS24.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE26.get(), DecoBlocks.DARKMETAL_BARS26.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE27.get(), DecoBlocks.DARKMETAL_BARS27.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE28.get(), DecoBlocks.DARKMETAL_BARS28.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE30.get(), DecoBlocks.DARKMETAL_BARS30.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE33.get(), DecoBlocks.DARKMETAL_BARS33.get(), DecoBlocks.DARKMETAL_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.DARKMETAL_VITRAGE_PANE34.get(), DecoBlocks.DARKMETAL_BARS34.get(), DecoBlocks.DARKMETAL_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE.get(), DecoBlocks.CLOUD_BARS.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE1.get(), DecoBlocks.CLOUD_BARS1.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE2.get(), DecoBlocks.CLOUD_BARS2.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE3.get(), DecoBlocks.CLOUD_BARS3.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE4.get(), DecoBlocks.CLOUD_BARS4.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE5.get(), DecoBlocks.CLOUD_BARS5.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE6.get(), DecoBlocks.CLOUD_BARS6.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE7.get(), DecoBlocks.CLOUD_BARS7.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE8.get(), DecoBlocks.CLOUD_BARS8.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE9.get(), DecoBlocks.CLOUD_BARS9.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE10.get(), DecoBlocks.CLOUD_BARS10.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE11.get(), DecoBlocks.CLOUD_BARS11.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE12.get(), DecoBlocks.CLOUD_BARS12.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE13.get(), DecoBlocks.CLOUD_BARS13.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE14.get(), DecoBlocks.CLOUD_BARS14.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE15.get(), DecoBlocks.CLOUD_BARS15.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE16.get(), DecoBlocks.CLOUD_BARS16.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE17.get(), DecoBlocks.CLOUD_BARS17.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE18.get(), DecoBlocks.CLOUD_BARS18.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE19.get(), DecoBlocks.CLOUD_BARS19.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE20.get(), DecoBlocks.CLOUD_BARS20.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE21.get(), DecoBlocks.CLOUD_BARS21.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE22.get(), DecoBlocks.CLOUD_BARS22.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE23.get(), DecoBlocks.CLOUD_BARS23.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE24.get(), DecoBlocks.CLOUD_BARS24.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE26.get(), DecoBlocks.CLOUD_BARS26.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE27.get(), DecoBlocks.CLOUD_BARS27.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE28.get(), DecoBlocks.CLOUD_BARS28.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE30.get(), DecoBlocks.CLOUD_BARS30.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE33.get(), DecoBlocks.CLOUD_BARS33.get(), DecoBlocks.CLOUD_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.CLOUD_VITRAGE_PANE34.get(), DecoBlocks.CLOUD_BARS34.get(), DecoBlocks.CLOUD_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get(), DecoBlocks.WAXED_COPPER_BARS.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_COPPER_BARS1.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_COPPER_BARS2.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_COPPER_BARS3.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_COPPER_BARS4.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_COPPER_BARS5.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_COPPER_BARS6.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_COPPER_BARS7.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_COPPER_BARS8.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_COPPER_BARS9.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_COPPER_BARS10.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_COPPER_BARS11.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_COPPER_BARS12.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_COPPER_BARS13.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_COPPER_BARS14.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_COPPER_BARS15.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_COPPER_BARS16.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_COPPER_BARS17.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_COPPER_BARS18.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_COPPER_BARS19.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_COPPER_BARS20.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_COPPER_BARS21.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_COPPER_BARS22.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_COPPER_BARS23.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_COPPER_BARS24.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_COPPER_BARS26.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_COPPER_BARS27.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_COPPER_BARS28.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_COPPER_BARS30.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_COPPER_BARS33.get(), DecoBlocks.WAXED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_COPPER_BARS34.get(), DecoBlocks.WAXED_COPPER_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS1.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS2.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS3.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS4.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS5.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS6.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS7.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS8.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS9.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS10.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS11.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS12.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS13.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS14.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS15.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS16.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS17.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS18.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS19.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS20.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS21.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS22.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS23.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS24.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS26.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS27.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS28.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS30.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS33.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS34.get(), DecoBlocks.WAXED_EXPOSED_COPPER_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS1.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS2.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS3.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS4.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS5.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS6.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS7.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS8.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS9.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS10.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS11.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS12.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS13.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS14.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS15.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS16.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS17.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS18.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS19.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS20.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS21.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS22.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS23.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS24.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS26.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS27.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS28.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS30.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS33.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS34.get(), DecoBlocks.WAXED_WEATHERED_COPPER_BARS.get());

        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE1.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS1.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE2.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS2.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE3.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS3.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE4.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS4.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE5.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS5.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE6.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS6.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE7.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS7.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE8.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS8.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE9.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS9.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE10.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS10.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE11.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS11.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE12.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS12.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE13.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS13.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE14.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS14.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE15.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS15.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE16.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS16.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE17.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS17.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE18.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS18.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE19.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS19.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE20.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS20.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE21.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS21.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE22.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS22.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE23.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS23.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE24.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS24.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE26.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS26.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE27.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS27.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE28.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS28.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE30.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS30.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE33.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS33.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
        vitrageMaking(recipe, RecipeCategory.DECORATIONS, DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE34.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS34.get(), DecoBlocks.WAXED_OXIDIZED_COPPER_BARS.get());
