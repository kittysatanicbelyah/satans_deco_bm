...
public static final RegistryObject<CreativeModeTab> BARS_TAB = CREATIVE_MODE_TAB_DEFERRED_REGISTER.register("bars_tab",
    ...
    public static final RegistryObject<CreativeModeTab> VITRAGES_TAB = CREATIVE_MODE_TAB_DEFERRED_REGISTER.register("vitrages_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(DecoBlocks.GOLD_VITRAGE_PANE4.get()))
                    .title(Component.translatable("creativetab.vitrages_tab"))
                    .displayItems((ItemDisplayParameters, output) -> {
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.IRON_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.IRON_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.GOLD_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.GOLD_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.EMERALD_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.DARKMETAL_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.CLOUD_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.WAXED_COPPER_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.WAXED_EXPOSED_COPPER_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.WAXED_WEATHERED_COPPER_VITRAGE_PANEL3.get());

                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE1.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE2.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE3.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE4.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE5.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE6.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE7.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE8.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE9.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE10.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE11.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE12.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE13.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE14.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE15.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE16.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE17.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE18.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE19.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE20.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE21.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE22.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE23.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE24.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE26.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE27.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE28.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE30.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE33.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANE34.get());

                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANEL1.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANEL2.get());
                        output.accept(DecoBlocks.WAXED_OXIDIZED_COPPER_VITRAGE_PANEL3.get());
                    })
                    .build());
    //Tabs end here
